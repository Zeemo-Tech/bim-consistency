...
import ViewportToolGlyph from './ViewportToolGlyph.vue'
import rulerIcon from '@/assets/images/celiang.svg'
...
<template>
  ...
  >
    ...
    >
      ...
      <img
        v-else-if="props.toggleIcon === 'ruler' || collapsed"
        class="measurement-toggle-icon"
        :src="rulerIcon"
        alt=""
      />
