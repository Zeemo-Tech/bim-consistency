      ...
      <header class="measurement-badge__header">
        ...
        <div class="measurement-badge__actions">
          ...
          <button
            v-if="closable"
            type="button"
            class="measurement-badge__close"
            title="隐藏测量结果"
...
.measurement-badge__header,
.measurement-badge__actions,
.measurement-badge__handle,
.measurement-badge__rows > div {
  display: flex;
  align-items: center;
}
...
.is-dragging .measurement-badge__handle {
  cursor: grabbing;
}

.measurement-badge__dots {
  width: 16px;
  height: 10px;
  opacity: 0.62;
...
.measurement-badge__title {
  color: rgb(255 255 255 / 68%);
  font-size: 12px;
  font-weight: 600;
}

.measurement-badge__actions button,
.measurement-badge__footer button {
  border: 0;
  border-radius: 5px;
  padding: 2px 7px;
  background: rgb(255 255 255 / 8%);
  color: rgb(181 206 255 / 95%);
  cursor: pointer;
  font-size: 11px;
}

.measurement-badge__actions .measurement-badge__close {
  width: 18px;
  height: 18px;
  padding: 0;
  color: #fff;
...
.measurement-badge__main {
  display: flex;
  flex-direction: column;
  gap: 1px;
}

.measurement-badge__main span {
  color: rgb(145 181 255 / 94%);
  font-size: 10px;
  font-weight: 600;
}

.measurement-badge__main strong {
  color: #fff;
  font-size: 18px;
  line-height: 1.15;
...
.measurement-badge__rows dt,
.measurement-badge__rows dd {
  margin: 0;
  font-size: 12px;
  font-weight: 600;
}
...
.measurement-badge__footer button {
  color: rgb(255 232 232 / 90%);
}

.measurement-badge__actions button:hover,
.measurement-badge__footer button:hover {
  background: rgb(255 255 255 / 16%);
}

.measurement-badge__footer button:hover {
  background: rgb(255 90 90 / 24%);
}
</style>
